...
export type FontKerning = WithNone<'auto' | 'normal'>
export type TextWrap = 'wrap' | 'nowrap'
export type TextAlign = WithNone<'center' | 'end' | 'left' | 'right' | 'start' | 'justify'>
export type TextTransform = WithNone<'uppercase' | 'lowercase'>
export type TextOrientation = 'mixed' | 'upright' | 'sideways-right' | 'sideways' /* | 'use-glyph-orientation' */
export type TextDecoration = WithNone<'underline' | 'line-through' | 'overline'>
...
export type BorderStyle = WithNone<'dashed' | 'solid'>
export type BoxSizing = 'border-box' | 'content-box'
export type PointerEvents = 'auto' | 'none'

// listStyle
export type ListStyleType = WithNone<'disc'>
export type ListStyleImage = WithNone<string>
export type ListStyleColormap = WithNone<Record<string, string>>
...
export type HighlightImage = WithNone<string>
export type HighlightReferImage = WithNone<string>
export type HighlightColormap = WithNone<Record<string, string>>
